...
AFR_eid<-fread2('/public/home/Datasets/ukb/pheno/eid_AFR.txt',col.names=c('eid','eid1'))
AFR_eid<-AFR_eid[,1]
#AFR Sorted by fixed number
binary_AFR<-binary_all[paste0('S',AFR_eid),]
colnames(binary_AFR)[2:4]<-c('sex','age','BMI')
...
#get sample
binary_female_sample<-binary_AFR[which(binary_AFR$sex==0),]
binary_male_sample<-binary_AFR[which(binary_AFR$sex==1),]
female_sort<-rownames(binary_female_sample)
male_sort<-rownames(binary_male_sample)
binary_nosex_sample<-binary_AFR
nosex_sort<-rownames(binary_AFR)
...
save(nosex_sort,file = '/public/home/biostat07/AFR_binary/temp/nosex_sort.RData')
save(summary_adjust_name,file = '/public/home/biostat07/AFR_binary/temp/summary_adjust_name.RData')
save(binary_female_sample,file = '/public/home/biostat07/AFR_binary/temp/binary_female_sample.RData')
save(binary_male_sample,file = '/public/home/biostat07/AFR_binary/temp/binary_male_sample.RData')
save(binary_nosex_sample,file = '/public/home/biostat07/AFR_binary/temp/binary_nosex_sample.RData')
save(binary_T1D_sample,file = '/public/home/biostat07/AFR_binary/temp/binary_T1D_sample.RData')
save(binary_T2D_sample,file = '/public/home/biostat07/AFR_binary/temp/binary_T2D_sample.RData')
save(binary_diabetes_sample,file = '/public/home/biostat07/AFR_binary/temp/binary_diabetes_sample.RData')
save(binary_AFR,file = '/public/home/biostat07/AFR_binary/temp/binary_AFR.RData')
save(temp_name,file = '/public/home/biostat07/AFR_binary/temp/temp_name.RData')