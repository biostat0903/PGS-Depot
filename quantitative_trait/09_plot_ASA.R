...
Prop<-c()
method_ord<-c()
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/CT/rsquare/',opt$pheno,'.txt'))){
  CT<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/CT/rsquare/',opt$pheno,'.txt'),header=F)[,1]
  if (all(!is.na(CT))){
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/SCT/rsquare/',opt$pheno,'.txt'))){
  SCT<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/SCT/rsquare/',opt$pheno,'.txt'),header=F)[,1]
  if (all(!is.na(SCT))){
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/LDpred2/rsquare/',opt$pheno,'_sp.txt'))){
  LDpred2_sp<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/LDpred2/rsquare/',opt$pheno,'_sp.txt'),header=F)[,1]
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/LDpred2/rsquare/',opt$pheno,'_nosp.txt'))){
  LDpred2_nosp<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/LDpred2/rsquare/',opt$pheno,'_nosp.txt'),header=F)[,1]
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/LDpred2/rsquare/',opt$pheno,'_auto.txt'))){
  LDpred2_auto<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/LDpred2/rsquare/',opt$pheno,'_auto.txt'),header=F)[,1]
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/LDpred2/rsquare/',opt$pheno,'_inf.txt'))){
  LDpred2_inf<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/LDpred2/rsquare/',opt$pheno,'_inf.txt'),header=F)[,1]
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/DBSLMM/rsquare/',opt$pheno,'.txt'))){
  DBSLMM<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/DBSLMM/rsquare/',opt$pheno,'.txt'),header=F)[,1]
  if (all(!is.na(DBSLMM))){
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/DBSLMM/rsquare/',opt$pheno,'_auto.txt'))){
  DBSLMM_auto<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/DBSLMM/rsquare/',opt$pheno,'_auto.txt'),header=F)[,1]
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/DBSLMM/rsquare/',opt$pheno,'_lmm.txt'))){
  DBSLMM_lmm<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/DBSLMM/rsquare/',opt$pheno,'_lmm.txt'),header=F)[,1]
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/PRScs/rsquare/',opt$pheno,'.txt'))){
  PRSCS<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/PRScs/rsquare/',opt$pheno,'.txt'),header=F)[,1]
  if (all(!is.na(PRSCS))){
...
if (file.exists(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/SBLUP/rsquare/',opt$pheno,'.txt'))){
  SBLUP<-fread2(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/SBLUP/rsquare/',opt$pheno,'.txt'),header=F)[,1]
  if (all(!is.na(SBLUP))){
...
jpeg(paste0('/public/home/biostat07/ASA/output_summary/',opt$pheno,'.effect/',opt$pheno,'_boxplot.jpeg'),
