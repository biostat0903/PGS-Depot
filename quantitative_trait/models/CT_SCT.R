...
#get_CT_SCT_function<-function(phenofile){
  ...
  save(grid2,file=paste0('/public/home/biostat07/Five_people/output_summary/',opt$phenofile,'.effect/RDATA/grid2_',opt$phenofile,'.RData'))
  ...
  save(snp_info_CT, idx_mat_CT, all_pgs_CT,
       file = paste0('/public/home/biostat07/Five_people/output_summary/',opt$phenofile,".effect/RDATA/CT_",opt$phenofile,'.RData'))
  ...
  snp_sig_SCT <- data.frame(ref_map$rsid[idx],
                            ...
                            new_beta[idx])
  #output
  write.table(grid2, file = paste0('/public/home/biostat07/Five_people/output_summary/',opt$phenofile,'.effect/grid2/',opt$phenofile,".txt"),
              col.names = F, row.names = F, quote = F)
  write.table(snp_sig_CT, file = paste0('/public/home/biostat07/Five_people/output_summary/',opt$phenofile,'.effect/CT/',opt$phenofile,".txt"),
              col.names = F, row.names = F, quote = F)
  write.table(snp_sig_SCT, file = paste0('/public/home/biostat07/Five_people/output_summary/',opt$phenofile,'.effect/SCT/',opt$phenofile,".txt"),
              col.names = F, row.names = F, quote = F)
